...
alias krus='kubectl --context=movio-prod-us --namespace=mc-red'
alias krfr='kubectl --context=movio-prod-fr --namespace=mc-red'
alias krcn='kubectl --context=movio-prod-cn --namespace=mc-red'
alias kreu='kubectl --context=movio-prod-eu --namespace=mc-red'
...
alias kdev='kubectl --context=movio-dev -n mc-app-pr'
